...
part of 'recommendation_api.dart';
...
class _RecommendationApi implements RecommendationApi {
  _RecommendationApi(
    this._dio, {
    this.baseUrl,
  });
