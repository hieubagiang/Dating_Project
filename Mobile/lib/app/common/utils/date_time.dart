...
class DateTimeUtils {
  ...
  static String? getStringTimeAgo(dynamic startTime, Pattern patternConvert,
      {String? languageCode, DateTime? endTime}) {
    final datetime = getTimestamp(startTime, patternConvert);
    final diff = (endTime ?? DateTime.now()).millisecondsSinceEpoch - datetime;
  ...
  static bool checkAgeInRange(int age, RangeValues range) {
  ...
  static String calculateCallDuration(DateTime startTime, DateTime endTime) {
