...
class ColorUtils {
  ...
  static const Color lightGreyColor = Color(0x33);
  ...
  static var borderColor = Color(0xffE5E5E5);
  //background color
  static var backgroundColor2 = Color(0xffF5F5F5);
  static var lightPrimary = Color.fromRGBO(253, 236, 238, 1);
...
class OpacityUtils {
  static const double primaryOpacity = 0.6;
}
